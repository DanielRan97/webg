  ...
  return (
    <header className="sticky top-0 z-30 border-b-[3px] border-black bg-t-brand text-t-brand-fg">
      <div className="mx-auto flex max-w-5xl items-center gap-4 px-5 py-3">
        ...
        <SiteNav nav={nav} linkClassName="text-sm font-bold underline-offset-4 hover:underline" />
        {d.phone && (
          <a href={telHref(d.phone)} className="shrink-0 rounded-md border-[3px] border-black bg-white px-4 py-1.5 text-sm font-extrabold text-black lg:hidden">התקשרו</a>
        )}
      </div>
    </header>
  );
  ...
  return (
    <section id="sec-hero" className="overflow-hidden bg-t-brand px-5 py-14 text-t-brand-fg md:py-24">
      <div className="mx-auto grid max-w-5xl items-center gap-10 md:grid-cols-[1.2fr_1fr]">
        ...
        {d.heroImageUrl && (
          <div className="flex aspect-[4/5] w-full max-w-sm items-center justify-center overflow-hidden rounded-md border-[3px] border-black bg-t-tint shadow-[8px_8px_0_0_#000] md:justify-self-end">
